...
function loadPlaceholderDialog() {
  const dialog = document.querySelector("[data-placeholder-dialog]");
  const triggers = document.querySelectorAll("[data-placeholder-modal]");
